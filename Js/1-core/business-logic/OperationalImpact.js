...
const OperationalImpact = (function () {
    // Helper para obter dependências
    function getDeps() {
        return {
            DateUtils: (typeof window !== 'undefined' && window.DateUtils) || (typeof require !== 'undefined' && require('../utilities/DateUtils.js')),
            MathUtils: (typeof window !== 'undefined' && window.MathUtils) || (typeof require !== 'undefined' && require('../utilities/MathUtils.js')),
            ValidationUtils: (typeof window !== 'undefined' && window.ValidationUtils) || (typeof require !== 'undefined' && require('../utilities/ValidationUtils.js'))
        };
    }
