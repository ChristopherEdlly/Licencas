...
const DateUtilsClass = require('../utilities/DateUtils.js');
const DateUtils = DateUtilsClass.DateUtils || DateUtilsClass;
const MathUtils = require('../utilities/MathUtils.js');
const ValidationUtilsModule = require('../utilities/ValidationUtils.js');
const ValidationUtils = ValidationUtilsModule.ValidationUtils || ValidationUtilsModule;
