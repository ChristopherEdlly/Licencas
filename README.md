# Dashboard de Cronogramas de Licenças

Uma aplicação web moderna para processar e visualizar cronogramas de licenças de servidores. Upload arquivo CSV/Excel, converte texto livre de cronogramas em datas estruturadas e exibe em dashboard interativa com gráficos e métricas.

## ⚡ Features Principais

- Upload de arquivos CSV/Excel com drag & drop
- Parser inteligente de cronogramas (texto → datas)
- Dashboard com KPIs, gráficos e timeline
- Interface responsiva e moderna
- Exportação de dados processados

## 🔧 Stack Tecnológica

HTML5, CSS3, Vanilla JavaScript, Chart.js, SheetJS

## 📊 Formato dos Dados

Colunas: Nome, Data Nascimento, Idade, Data Admissão, Departamentos, **Cronograma**

Exemplos de cronogramas suportados:
- Meses: 09/2026; 09/2027; 09/2028.
- A partir de 01/04/2026
- Início em 10/2025 (12 meses consecutivos)
- Um mês (janeiro) a cada ano
- 16/11/25 (um mês) e janeiro de cada ano, a partir de 2027.

## 🔄 Conversão Power Query → JavaScript
...
irá:
- Converter sintaxe Power Query para JavaScript
- Adaptar funções nativas (Text.Contains, List.Accumulate, etc.)
- Manter a lógica de parsing intacta
- Gerar código JavaScript otimizado para o browser

## 📝 Instruções

Crie uma aplicação web completa com:

1. **index.html** - Interface principal com upload, dashboard e tabelas
2. **styles.css** - Design moderno e responsivo 
3. **cronogramaParser.js** - Conversão da lógica Power Query para JavaScript
4. **dashboard.js** - Lógica da aplicação, gráficos e interações

A aplicação deve processar dados de servidores em formato CSV/Excel e gerar visualizações interativas dos cronogramas de licenças.